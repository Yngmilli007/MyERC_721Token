...
async function main() {
    const replace_contractAddress = "0x5E1bEccfEB82D2a284380E017a14A8E23914CA41";
    const [from] = await hre.web3.eth.getAccounts();
    const contractFactory = await hre.ethers.getContractFactory("YngNFT");
    ...
    const replace_functionArgs = "0x19ECb8C7F1e5d4A2716Cc7c492BDDf98a71cd773"; // Recipient address
